...
[GW Intel x86_64 mac dmg installer](https://github.com/kcleal/gw/releases/download/v1.0.3/gw_macos_intel.dmg)

[GW Apple arm64 mac dmg installer](https://github.com/kcleal/gw/releases/download/v1.0.3/gw_macos_m1.dmg)
